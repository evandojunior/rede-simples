...
?><table width="100%" border="0" cellspacing="0" cellpadding="0" class="verdana_11">
      <tr>
        <td colspan="2" height="26" background="/corporativo/servicos/bbhive/images/barra_horizontal.jpg">&nbsp;<img src="/corporativo/servicos/bbhive/images/listaIII.gif" border="0" align="absmiddle" />&nbsp;<strong>Console de busca avan&ccedil;ada <?php echo $_SESSION['FluxoNome']; ?>/<?php echo $_SESSION['TarefasNome']; ?></strong>
			...
			$complemento= "";
              ...
              do {
                ...
                <td width="270" height="1" valign="top">
                  <a href="#@" title="clique para consultar este modelo" onClick="return LoadSimultaneo('perfil/index.php?perfil=1&tarefas=1|tarefas/avancada/regra3.php?bbh_tip_flu_codigo=<?php echo $_GET['bbh_tip_flu_codigo']; ?>&bbh_mod_flu_codigo=<?php echo $row_Fluxos['bbh_mod_flu_codigo']; ?><?php echo $complemento; ?>','menuEsquerda|conteudoGeral');">
