...
$bbh_flu_codigo = isset($bbh_flu_codigo) ? "AND bbh_flu_codigo=".$bbh_flu_codigo : "";
	...
	$query_mensagens = "
					select 
					 ...
					 d.bbh_usu_apelido as remetente, #inversão
					 ...
					 r.bbh_usu_codigo as cdremetente
					  ...
					  from bbh_mensagens as m
						...
						inner join bbh_usuario as d on m.bbh_usu_codigo_destin = d.bbh_usu_codigo
						  ...
						  WHERE 
						   m.bbh_usu_codigo_remet = ".$_SESSION['usuCod']." $bbh_flu_codigo
							AND m.bbh_men_exclusao_remetente ='0' $SQLAjuste
	...
	$query_contadormsg = "SELECT 
							bbh_usu_codigo_destin 
								FROM bbh_mensagens 
									WHERE 
										bbh_usu_codigo_remet = ".$_SESSION['usuCod']." $bbh_flu_codigo
										  AND bbh_mensagens.bbh_men_exclusao_remetente = '0' $SQLAjuste";
    list($contadormsg, $row_contadormsg, $totalRows_contadormsg) = executeQuery($bbhive, $database_bbhive, $query_contadormsg);
	
/*===============================INICIO AUDITORIA POLICY=========================================*/
$_SESSION['relevancia']="0";
$_SESSION['nivel']="1.1";
$Evento="Acessou a caixa de saída - BBHive corporativo.";
EnviaPolicy($Evento);
