<?php
 ...
 if(isset($_GET['abandona'])&&$_GET['abandona']=="sim"){
	 header("Location: /servicos/bbpass/login.php");
 }
 ...
 include($_SESSION['caminhoFisico']."/servicos/bbpass/includes/autenticacao/autentica.php");
 ...
 //INCLUSÃO DO ARQUIVO VERIFICA - responsável por validar se o usuário está logado
  ...
  if($_SERVER['SCRIPT_NAME']!="/servicos/bbpass/login.php"){
	include($_SESSION['caminhoFisico']."/servicos/bbpass/includes/autenticacao/verifica_autenticidade.php");
  }
  
 //INCLUSÃO DO ARQUIVO LOGOUT - responsável pela destruição de todas as sessões do sistema
 include($_SESSION['caminhoFisico']."/servicos/bbpass/includes/autenticacao/logout.php");
?>