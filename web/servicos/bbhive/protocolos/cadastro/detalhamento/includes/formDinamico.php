...
$readOnly = isset($readOnly) ? $readOnly : "";
			...
			$observacao = nl2br($row_campos_detalhamento['bbh_cam_det_pro_descricao']);
			$observacao = preg_replace("@\n|\r|\n\r@",'', $observacao);
				...
				{				
                    ...
                    case "json":
                        echo "Integração de sistemas (JSON)";
                        break;
                    case "hidden":
					...
					case "lista_opcoes":
						...
						if($row_campos_detalhamento['bbh_cam_det_pro_nome'] == 'bbh_ind_sigilo')
						{
							//
					...
					//======Número decimal
					  case "numero_decimal":	
								...
								echo '<input type="text" name="'.$nomeFisico.'" id="'.$nomeFisico.'" value="' . $valor . '" class="back_input" maxlength="'.$tamanho.'" onKeyUp="maskIt(this,event,\'###.###.###.###.###.###.###,##\',true)" size="30" '.$readOnly.'/>';
//								echo '<input type="text" name="'.$nomeFisico.'" id="'.$nomeFisico.'" value="' . $valor . '" class="back_input" maxlength="'.$tamanho.'" onKeyUp="maskIt(this,event,\'###.###.###.###.###.###.###,##\',true)" onkeyPress="return(MascaraMoeda(this,\'.\',\',\',event));" size="30" '.$readOnly.'/>';
					...
					//====Número inteiro
						case "numero":
							echo '<input type="text"  name="'.$nomeFisico.'" id="'.$nomeFisico.'" value="' . $valorPadrao . '" class="back_input" maxlength="'.$tamanho.'" onKeyUp="SomenteNumerico(this);" size="30" '.$readOnly.'/>';
