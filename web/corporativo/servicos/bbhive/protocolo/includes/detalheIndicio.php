...
list($tabela_fisica, $row_tabela_fisica, $totalRows_tabela_fisica) = executeQuery($bbhive, $database_bbhive, $query_tabela_fisica);
    ...
    $copiaDetalhamento = $campos_detalhamento;
...
?><table width="98%" border="0" align="right" cellpadding="0" cellspacing="0" bgcolor="#FFFFCC">
  ...
  <tr>
	...
	// Concatena
	echo isset($credibilidade['bbh_ind_confiabilidade_fonte']) && isset($credibilidade['bbh_ind_veracidade_informacao']) ?
        $credibilidade['bbh_ind_confiabilidade_fonte'].$credibilidade['bbh_ind_veracidade_informacao'] : 'Não há informações disponíveis';
	?>    
    </td>
