    ...
    <table width="777" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <tr>
                ...
                <td width="80%" align="left" class="verdana_11">&nbsp;<input name="pol_graf_codigo" type="hidden" class="verdana_11" id="pol_graf_codigo" value="<?php if (isset($_GET['pol_graf_codigo']) && $_GET['pol_graf_codigo'] == 'pizza') { echo 'pizza"'; } ?>" size="35" maxlength="75" /></td>
              </tr>
