...
if(isset($_SESSION["urlAnteriorCop"])){

		$_SESSION['urlEnviaCop'] = $_SESSION['urlAnteriorCop'];
		$_SESSION['exPaginaCop'] = $_SESSION['exAnteriorCop']	;
...
<script>
function bbpass(){
	parent.frames['login'].location ="<?php echo $_SESSION['EndURL_BBPASS']; ?>/servicos/bbpass/modulos_autenticacao/autenticaRemoto.php?<?php echo "idApl=".$idAplicacaoBBPASS_Corporativo; ?>";
}
...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="middle"><table width="420" border="0" cellpadding="0" cellspacing="0" bgcolor="#F1F3F8" class="borderAlljanela">
      <tr>
        <td height="90" background="/datafiles/servicos/bbhive/corporativo/images/sistema/cabecalho_login.jpg">&nbsp;</td>
      </tr>
      <tr>
