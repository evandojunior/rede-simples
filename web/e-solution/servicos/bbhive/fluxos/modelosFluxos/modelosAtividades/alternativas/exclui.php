...
include($_SESSION['caminhoFisico']."/e-solution/servicos/bbhive/includes/functions.php");
	...
	$homeDestinoII	= '/e-solution/servicos/bbhive/fluxos/modelosFluxos/modelosAtividades/alternativas/exclui.php';
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "cadastraMod")) {
	$deleteSQL = "DELETE FROM bbh_fluxo_alternativa WHERE bbh_flu_alt_codigo = ".$_POST['bbh_flu_alt_codigo'];
...
?>
<var style="display:none">txtSimples('tagPerfil', 'Exclus&atilde;o de Alternativas')</var>
...
<form name="cadatraAlt" id="cadatraAlt" style="margin-top:-1px;">
    <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      <tr>
        <td height="24" background="/e-solution/servicos/bbhive/images/cabAtiv.gif" class="legandaLabel11"><strong>&nbsp;Exclus&atilde;o de alternativas</strong>
          ...
          <tr>
            <td width="590" height="60" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td width="71%">&nbsp;<input class="back_Campos" name="bbh_flu_alt_titulo" type="text" id="bbh_flu_alt_titulo" size="60" style="height:17px;border:#E3D6A4 solid 1px;" value="<?php echo $row_Alternativas['bbh_flu_alt_titulo']; ?>"  disabled="disabled"/></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td>
                <label>
                  <select name="bbh_atividade_predileta" id="bbh_atividade_predileta"  class="legandaLabel11"  disabled="disabled">
                  	<?php for($a=1; $a<101; $a++){ ?>
              ...
              <tr>
                ...
                <td><label>
                  <textarea class="back_Campos" name="bbh_flu_observacao" id="bbh_flu_observacao" rows="5" cols="70" style="border:#E3D6A4 solid 1px;" disabled="disabled"><?php echo $row_Alternativas['bbh_flu_alt_titulo']; ?></textarea>
                </label></td>
              </tr>
            </table></td>
          </tr>
          ...
          <tr>
            ...
            <div style="float:right; margin-top:-13px">
                <input name="button" type="button" class="back_input" id="button" value="Cancelar"  onClick="LoadSimultaneo('perfil/index.php?perfil=2|fluxos/modelosFluxos/modelosAtividades/alternativas/index.php?bbh_mod_flu_codigo=<?php echo $_GET['bbh_mod_flu_codigo']; ?>&bbh_mod_ati_codigo=<?php echo $_GET['bbh_mod_ati_codigo']; ?>','menuEsquerda|conteudoGeral');" style="cursor:pointer; background-image:url(/e-solution/servicos/bbhive/images/search.gif); color:#FFFFFF"/>
                                               <input name="insereModelo" type="button" class="back_input" id="insereModelo" value="Excluir alternativa" style="cursor:pointer; background-image:url(/e-solution/servicos/bbhive/images/search.gif); color:#FFFFFF" onclick="return validaForm('cadatraAlt', 'bbh_flu_alt_titulo|Escreva o t&iacute;tulo da alternativa, bbh_mod_flu_codigo|Escolha o modelo de fluxo', document.getElementById('acaoForm').value)" <?php if($row_Fluxo['Total']>0) { echo 'disabled="disabled"';} ?>/>
                                               &nbsp;&nbsp;&nbsp;            </div>    </td>
          </tr>
          <tr>
            <td height="5"></td>
