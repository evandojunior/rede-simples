...
<table width="765" border="0" align="left" cellpadding="0" cellspacing="0" style="margin-top:5px;margin-bottom:10px;">
  <tr>
    ...
    <input name="cadastrar" onclick="voltarURL('/e-solution/servicos/bbpass/modulo/config/biometria_nitgen/index.php?bbp_adm_loc_codigo=<?php echo $_GET['bbp_adm_loc_codigo']; ?>');" type="button" class="botaoVoltar back_input" id="cadastrar" value="&nbsp;&nbsp;&nbsp;Cancelar cadastro" style="float:right;margin-right:10px;margin-top:-19px;background-color:#FFF"/>
    </td>
  ...
  <tr>
    <td height="410" colspan="3" align="center" valign="top" bgcolor="#FFFFFF" class="legendaLabel14" style="border-left:#DCDFE1 solid 1px;border-right:#DCDFE1 solid 1px;border-bottom:#DCDFE1 solid 1px;"><iframe allowtransparency="true" src="/e-solution/servicos/bbpass/modulo/config/biometria_nitgen/formulario.php?bbp_adm_loc_codigo=<?php echo $_GET['bbp_adm_loc_codigo']; ?>&bbp_adm_lock_log_codigo=<?php echo $_GET['bbp_adm_lock_log_codigo']; ?>" name="autBBPASS" height="350" width="750" frameborder="0"></iframe>
