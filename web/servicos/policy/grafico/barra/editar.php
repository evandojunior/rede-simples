...
if ( isset ($_POST['pol_graf_codigo']) )  {
 ...
 $updateSQL = "UPDATE pol_grafico SET pol_graf_titulo = '".$_POST['pol_graf_titulo']."', pol_pol_codigo = ".$_POST['pol_pol_codigo'].", pol_graf_grupo= '".$_POST['pol_graf_grupo']."' WHERE pol_graf_codigo = " . $_POST['pol_graf_codigo'];
    ...
    <table width="777" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <tr>
                ...
                <td width="80%" align="left" class="verdana_11">&nbsp;<input name="pol_graf_codigo" type="hidden" class="verdana_11" id="pol_graf_codigo" value="<?php if (isset($_GET['pol_graf_codigo']) && $_GET['pol_graf_codigo'] == 'barra') { echo 'barra"'; } ?>" size="35" maxlength="75" /></td>
              </tr>
              ...
              <tr>
                ...
                <td align="left" class="verdana_11">
                    ...
                    <label>
                      <input type="radio" name="pol_graf_grupo" value="1" id="pol_graf_grupo_1"  <?php if ( isset( $row_grafico['pol_graf_grupo']) && $row_grafico['pol_graf_grupo'] == '1') { echo 'checked="checked"'; } ?> />
                      Quem</label>
                    <br />
                    <label>
                      <input type="radio" name="pol_graf_grupo" value="2" id="pol_graf_grupo_2" <?php if ( isset( $row_grafico['pol_graf_grupo']) && $row_grafico['pol_graf_grupo'] == '2') { echo 'checked="checked"'; } ?> />
                      O quê</label>
                    <br />
                    <label>
                      <input type="radio" name="pol_graf_grupo" value="3" id="pol_graf_grupo_3" <?php if ( isset( $row_grafico['pol_graf_grupo']) && $row_grafico['pol_graf_grupo'] == '3') { echo 'checked="checked"'; } ?> />
                      Quando</label>
                    <br />
                    <label>
                      <input type="radio" name="pol_graf_grupo" value="4" id="pol_graf_grupo_4" <?php if ( isset( $row_grafico['pol_graf_grupo']) && $row_grafico['pol_graf_grupo'] == '4') { echo 'checked="checked"'; } ?> />
                      Onde</label>
                    <br />
                    <label>
                      <input type="radio" name="pol_graf_grupo" value="5" id="pol_graf_grupo_5" <?php if ( isset( $row_grafico['pol_graf_grupo']) && $row_grafico['pol_graf_grupo'] == '5') { echo 'checked="checked"'; } ?> />
                      Relevância</label>
                    <br />
                  </p></td>
              </tr>
