...
if(isset($_POST['atualiza'])){
		...
		$excluido = $sms->bbp_adm_lock_sms_email;
...
/*===============================FIM AUDITORIA POLICY============================================*/
	...
	$sms->excluiDados($database_bbpass, $bbpass);//UPDATE
...
<table width="765" border="0" align="left" cellpadding="0" cellspacing="0" style="margin-top:5px;margin-bottom:10px;">
  <tr>
    ...
    <td width="758" align="left" bgcolor="#F2E6B5" class="fonteDestaque" style="color:#3078B6"><img src="/e-solution/servicos/bbpass/images/engrenagem.gif" width="17" height="16" align="absmiddle" />&nbsp;<strong>Exclus&atilde;o de dados - <?php echo $modulo->nomeAplicacao($database_bbpass, $bbpass, $_GET['bbp_adm_loc_codigo']); ?></strong></td>
...
<form action="/e-solution/servicos/bbpass/modulo/config/sms/excluir.php" method="post" id="atualizaPerfil" name="atualizaPerfil">
  ...
  <tr>
    ...
    <td width="422" height="25"><input name="bbp_adm_lock_sms_nome" type="text" class="back_Campos" id="bbp_adm_lock_sms_nome" size="50" value="<?php echo $sms->bbp_adm_lock_sms_nome; ?>" disabled="disabled"/>
  ...
  <tr>
    ...
    <td height="25"><input name="bbp_adm_lock_sms_email" type="text" class="back_Campos" id="bbp_adm_lock_sms_email" size="40" value="<?php echo $sms->bbp_adm_lock_sms_email; ?>" disabled="disabled"/></td>
    </tr>
  <tr>
    <td height="25" align="right" class="legendaLabel11"><strong>Celular do usu&aacute;rio </strong>:&nbsp;</td>
    <td height="25"><input name="bbp_adm_lock_sms_celular" type="text" class="back_Campos" id="bbp_adm_lock_sms_celular" size="30" value="<?php echo $sms->bbp_adm_lock_sms_celular; ?>" disabled="disabled"/></td>
  </tr>
  <tr>
    <td height="25" align="right" valign="top" class="legendaLabel11"><strong>Observa&ccedil;&atilde;o</strong> :&nbsp;</td>
    <td height="25"><textarea name="bbp_adm_lock_sms_observacao" id="bbp_adm_lock_sms_observacao" cols="78" rows="6" class="formulario2" disabled="disabled"><?php echo $sms->bbp_adm_lock_sms_observacao; ?></textarea></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <input name="cadastrar" onclick="voltarURL('/e-solution/servicos/bbpass/modulo/config/sms/index.php?bbp_adm_loc_codigo=<?php echo $_GET['bbp_adm_loc_codigo']; ?>');" type="button" class="botaoVoltar back_input" id="cadastrar" value="&nbsp;&nbsp;&nbsp;Cancelar exclus&atilde;o"/>
  <?php
...
/*===============================INICIO AUDITORIA POLICY=========================================*/
	...
	$Evento="Acessou a página de exclusão do usuário ".$sms->bbp_adm_lock_sms_email." do módulo ".$modulo->nomeAplicacao($database_bbpass, $bbpass, $_GET['bbp_adm_loc_codigo']).".";
	EnviaPolicy($Evento);
/*===============================FIM AUDITORIA POLICY============================================*/
?>