<form action="<?php echo $_SESSION['EndURL_BBPASS']; ?>/servicos/bbpass/modulos_autenticacao/modulos/login_acad.php" method="post">
  <table width="380" border="0" cellspacing="0" cellpadding="0" class="verdana_12">
    ...
    <tr>
      ...
      <td width="79%"><label>
        &nbsp;<input name="cid_email" type="text" class='back_Campos' id="cid_email" size="31">
      </label></td>
    </tr>
    <?php } ?>
    <tr>
      ...
      <td valign="baseline"><label>
        &nbsp;<input name="cid_senha" type="password" id="cid_senha" size="20" class='back_Campos'>
        &nbsp;
        <input name="button" type="submit" class="back_input" id="button" value="Entrar">
      </label></td>
    </tr>
    <tr>
      <td height="25" align="right"><input type="hidden" name="autenticaCidadaoSenha" id="autenticaCidadaoSenha" value="1">
      <input type="hidden" name="idAplicacao" id="idAplicacao" value="<?php echo isset($_POST['idAplicacao'])?$_POST['idAplicacao']:@$idAplic; ?>">
      <input type="hidden" name="idLock" id="idLock" value="<?php echo @isset($_POST['idLock'])?$_POST['idLock']:@$idLock; ?>"></td>
      <td><label>
      &nbsp; </label></td>
    </tr>
  </table>
