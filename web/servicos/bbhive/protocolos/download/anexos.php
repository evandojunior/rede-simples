...
$codigo_usuario = $_SESSION['pub_usuCod'];
...
//PROCEDIMENTO DE DUPLICAÇÃO DE ARQUIVO PARA DOWNLOAD PELO WEBSERVICE - APACHE/IIS
	...
	$destino.= "/".$_SESSION['pub_usuCod'];
		...
		header("Location: /datafiles/servicos/bbhive/temp_transf/".$_SESSION['pub_usuCod']."/".strtolower($nome_arquivo));
//=====================================================================================		
