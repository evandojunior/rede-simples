...
class LoginChave extends RecoverConnection {
	public $bbp_adm_lock_log_codigo;
	public $bbp_adm_lock_log_nome;
	public $bbp_adm_lock_log_chave;
	...
	public function consultaLogin($database_bbpass, $bbpass, $compPaginacao){
		...
		$Log_query ="select * FROM bbp_adm_lock_loginchave ORDER BY bbp_adm_lock_log_nome ASC $compPaginacao";
	...
	public function totalLogin($database_bbpass, $bbpass){
		...
		$Log_query ="select COUNT(bbp_adm_lock_log_codigo) as TOTAL FROM bbp_adm_lock_loginchave";
	...
	public function dadosLogin($database_bbpass, $bbpass, $bbp_adm_lock_log_codigo){
		...
		$Log_query ="select * FROM bbp_adm_lock_loginchave Where bbp_adm_lock_log_codigo=".$bbp_adm_lock_log_codigo;
        list($Log, $row_Log, $totalRows) = executeQuery($bbpass, $database_bbpass, $Log_query);
		  
        $this->bbp_adm_lock_log_codigo	= $row_Log['bbp_adm_lock_log_codigo'];
        $this->bbp_adm_lock_log_nome	= $row_Log['bbp_adm_lock_log_nome'];
        $this->bbp_adm_lock_log_chave	= $row_Log['bbp_adm_lock_log_chave'];
	...
	public function verificaRepetido($database_bbpass, $bbpass, $notIn){
		...
		$Log_query ="select COUNT(bbp_adm_lock_log_codigo) as TOTAL FROM bbp_adm_lock_loginchave Where bbp_adm_lock_log_chave='".$this->bbp_adm_lock_log_chave."' $notIn";
        list($Log, $row_Log, $totalRows) = executeQuery($bbpass, $database_bbpass, $Log_query);
	...
	public function cadastraDados($database_bbpass, $bbpass){
        ...
        $insertSQL = "INSERT INTO bbp_adm_lock_loginchave (bbp_adm_lock_log_nome,bbp_adm_lock_log_chave,bbp_adm_lock_log_senha,bbh_adm_lock_log_sexo,bbp_adm_lock_log_ativo) VALUES ('".$this->bbp_adm_lock_log_nome."', '".$this->bbp_adm_lock_log_chave."', '".$this->bbp_adm_lock_log_senha."','".$this->bbh_adm_lock_log_sexo."','".$this->bbp_adm_lock_log_ativo."')";
	...
	public function atualizaDados($database_bbpass, $bbpass, $complSenha){
	    ...
	    $updateSQL = "UPDATE bbp_adm_lock_loginchave SET bbp_adm_lock_log_nome='".$this->bbp_adm_lock_log_nome."', bbp_adm_lock_log_chave='".$this->bbp_adm_lock_log_chave."',bbh_adm_lock_log_sexo='".$this->bbh_adm_lock_log_sexo."', bbp_adm_lock_log_ativo='".$this->bbp_adm_lock_log_ativo."' $complSenha Where bbp_adm_lock_log_codigo=".$this->bbp_adm_lock_log_codigo;
	...
	public function excluiDados($database_bbpass, $bbpass){
        ...
        if (!empty($this->bbp_adm_lock_log_codigo)) {
            $deleteSQL = "DELETE from bbp_adm_lock_loginchave Where bbp_adm_lock_log_codigo=" . $this->bbp_adm_lock_log_codigo;
