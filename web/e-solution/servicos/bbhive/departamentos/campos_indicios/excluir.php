...
include($_SESSION['caminhoFisico']."/e-solution/servicos/bbhive/includes/functions.php");
	...
	$homeDestino	= '/e-solution/servicos/bbhive/departamentos/campos_indicios/excluir.php';
...
if ((isset($_POST["MM_delete"])) && ($_POST["MM_delete"] == "cadastraDet")) {
	...
	//--Remove todos os campos adicionados
    $deleteSQL = "DELETE FROM bbh_tipo_indicio WHERE bbh_tip_codigo=$nvId";
    list($Result1, $rows, $totalRows) = executeQuery($bbhive, $database_bbhive, $deleteSQL, $initResult = false);
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="verdana_10">
  <tr>
    <td height="26" colspan="3" background="/e-solution/servicos/bbhive/images/barra_horizontal.jpg" class="verdana_11_bold"><img src="/e-solution/servicos/bbhive/images/ger-fluxo-16px.gif" width="16" height="16" align="absmiddle" /> <strong>Gerenciamento campos deste departamento</strong></td>
    <td width="53%" align="right" background="/e-solution/servicos/bbhive/images/barra_horizontal.jpg"><a href="#@" onClick="LoadSimultaneo('perfil/index.php?perfil=2|departamentos/campos_indicios/regra.php','menuEsquerda|conteudoGeral');"><span class="verdana_11_bold color">.:&nbsp;Voltar&nbsp;:.</span></a>&nbsp;</td>
  </tr>
  <tr>
    <td height="8" colspan="4">&nbsp;&nbsp;&nbsp;<img src="/corporativo/servicos/bbhive/images/departamentoII.gif" width="16" height="16" border="0" align="absmiddle" title="Departamento" />&nbsp;<strong><?php echo $row_departamentos['bbh_dep_nome']; ?></strong></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td height="25" colspan="3" bgcolor="#F5F5F5"><input name="bbh_tip_nome" type="text" disabled="disabled" class="back_Campos" id="bbh_tip_nome" value="<?php echo $row_Tipo['bbh_tip_nome']; ?>" size="60" maxlength="255"></td>
  </tr>
  <tr>
    <td height="25" align="right"><strong>Publicado :&nbsp;</strong></td>
    <td width="17%" height="25"><label for="bbh_tip_ativo"></label>
      <select name="bbh_tip_ativo" id="bbh_tip_ativo" class="verdana_11" disabled="disabled">
    ...
    <td width="38%"><select name="bbh_tipo_corp" id="bbh_tipo_corp" class="verdana_11" disabled="disabled">
  ...
  <tr>
    ...
    <td height="25" colspan="3" bgcolor="#F5F5F5"><textarea name="bbh_tip_descricao" cols="80" rows="2" disabled="disabled" class="formulario2" id="bbh_tip_descricao"><?php echo $row_Tipo['bbh_tip_descricao']; ?></textarea></td>
  </tr>
</table>
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
		 ...
		 ?>
              <tr>
                <td width="100%" height="20" colspan="3" valign="top" background="/e-solution/servicos/bbhive/images/cabFlux.gif">&nbsp;
                    <label>
                    <input type="checkbox" name="cam_det_<?php echo $idcampo; ?>" id="cam_det_<?php echo $idcampo; ?>" value="<?php echo $idcampo; ?>" <?php echo $ck;?> disabled="disabled" />
                    </label>
                    <select name="ordem_<?php echo $idcampo; ?>" id="ordem_<?php echo $idcampo; ?>" class="verdana_11" disabled="disabled">
          ...
          <tr>
            <td height="24" class="legandaLabel11"><div style="float:right;">
                <input name="button" type="button" class="back_input" id="button" value="Cancelar"  onClick="LoadSimultaneo('perfil/index.php?perfil=2|departamentos/campos_indicios/regra.php','menuEsquerda|conteudoGeral');" style="cursor:pointer; background-image:url(/e-solution/servicos/bbhive/images/search.gif); color:#FFFFFF"/>
                                               <input name="insereModelo" type="button" class="back_input" id="insereModelo" value="Excluir informa&ccedil;&otilde;es" style="cursor:pointer; background-image:url(/e-solution/servicos/bbhive/images/search.gif); color:#FFFFFF" onClick="return validaForm('cadatraDep', 'bbh_tip_nome|Preencha o título do tipo', document.getElementById('acaoForm').value);"/>
                                               &nbsp;&nbsp;&nbsp;            </div>    </td>
          </tr>
          <tr>
            <td height="5"></td>
	...
	<input type="hidden" name="MM_delete" id="MM_delete" value="cadastraDet" />
