...
$relevancia = mysqli_query($policy, $query_relevancia) or die(mysql_error());
$row_relevancia = mysqli_fetch_assoc($relevancia);
$totalRows_relevancia = mysqli_num_rows($relevancia);
?>
...
<?php 
      ...
      <?php } while ($row_relevancia = mysqli_fetch_assoc($relevancia)); ?>
