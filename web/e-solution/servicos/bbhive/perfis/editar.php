...
include($_SESSION['caminhoFisico']."/e-solution/servicos/bbhive/includes/functions.php");
	...
	//Ação FORM
	$TimeStamp 		= time();
	$homeDestino	= '/e-solution/servicos/bbhive/perfis/editar.php?Ts='.$TimeStamp;
	$idMensagemFinal= 'menLoad';
	$infoGet_Post	= 'editaPerfil';//Se envio for POST, colocar nome do formulário
...
$query_perfil = "SELECT * FROM bbh_perfil WHERE bbh_per_codigo = '$codigo'";
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "editaPerfil")) {
	...
	if(isset($_POST['bbh_per_matriz'])){	
		$bbh_per_matriz	= ($_POST['bbh_per_matriz']);
	}
	...
	$novorel  = $reltperfil;
	$novoprt  = $protperfil;
	$novocentral = isset($_POST['bbh_per_central_indicios']) ? 1 : 0;
	$novobi 		= isset($_POST['bbh_per_bi']) ? 1 : 0;
	$novogeo 		= isset($_POST['bbh_per_geo']) ? 1 : 0;
	$novopeoplerank = isset($_POST['bbh_per_peoplerank']) ? 1 : 0;

	$query_validacao = "SELECT * FROM bbh_perfil WHERE bbh_per_nome = '$novonome' AND bbh_per_codigo != $novocod";
	...
	if($totalRows_validacao==0){
	  $updateSQL = "UPDATE bbh_perfil SET bbh_per_nome = '$novonome', bbh_per_observacao = '$novaobs', bbh_per_fluxo = '$novoflu', bbh_per_mensagem = '$novomsg', bbh_per_arquivos = '$novoged', bbh_per_equipe = '$novoeqp', bbh_per_tarefas = '$novotar', bbh_per_relatorios = '$novorel', bbh_per_protocolos = '$novoprt', bbh_per_central_indicios='$novocentral', bbh_per_bi='$novobi', bbh_per_geo='$novogeo', bbh_per_peoplerank='$novopeoplerank', bbh_per_matriz = '$bbh_per_matriz', bbh_per_unidade = '$bbh_per_unidade', bbh_per_corp='$bbh_per_corp', bbh_per_pub='$bbh_per_pub'  WHERE bbh_per_codigo = $novocod";
...
?><form method="POST" name="editaPerfil" id="editaPerfil">
...
background="/e-solution/servicos/bbhive/images/barra_horizontal.jpg" class="verdana_11_bold"><img src="/e-solution/servicos/bbhive/images/ger-perfis-16px.gif" width="16" height="16" align="absmiddle" /> Gerenciamento de <?php echo $_SESSION['adm_perfNome']; ?>
...
src="/e-solution/servicos/bbhive/images/apontadireita.gif" alt="" width="4" height="8" align="absmiddle" /> Edi&ccedil;&atilde;o de perfil</span></td>
  </tr>
  <tr>
    <td width="7%">&nbsp;</td>
  ...
  <tr>
    <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td width="82%">&nbsp;
          <input name="bbh_per_nome" type="text" class="back_Campos" id="bbh_per_nome" value="<?php echo $row_perfil['bbh_per_nome']; ?>" size="45" maxlength="255">
      ...
      <tr>
        ...
        <td><table class="verdana_9" style="margin-left:6px; border:#E1EDFF 1px solid;" width="450" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="10">&nbsp;</td>
            <td width="197"><input name="bbh_per_fluxo" type="checkbox" id="bbh_per_fluxo" value="1" <?php if($row_perfil['bbh_per_fluxo']>0){echo "checked";} ?> />
            ...
            <td width="169"><input name="bbh_per_tarefas" type="checkbox" id="bbh_per_tarefas" value="1" <?php if($row_perfil['bbh_per_tarefas']>0){echo "checked";} ?> />
              <img src="/e-solution/servicos/bbhive/images/tarefa.gif" alt="" width="16" height="16" align="absmiddle" /> Tarefas</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td><input name="bbh_per_mensagem" type="checkbox" id="bbh_per_mensagem" value="1" <?php if($row_perfil['bbh_per_mensagem']>0){echo "checked";} ?> />
            ...
            <td><input name="bbh_per_relatorios" type="checkbox" id="bbh_per_relatorios" value="1" <?php if($row_perfil['bbh_per_relatorios']>0){echo "checked";} ?> />
              <img src="/e-solution/servicos/bbhive/images/relatorio.gif" alt="" width="16" height="16" align="absmiddle" /> Relat&oacute;rios</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td><input name="bbh_per_arquivos" type="checkbox" id="bbh_per_arquivos" value="1" <?php if($row_perfil['bbh_per_arquivos']>0){echo "checked";} ?> />
              <img src="/e-solution/servicos/bbhive/images/arquivos16px.gif" alt="" width="16" height="16" align="absmiddle" /> GED</td>
            <td><input name="bbh_per_protocolos" type="checkbox" id="bbh_per_protocolos" value="1" <?php if($row_perfil['bbh_per_protocolos']>0){echo "checked";} ?> />
          ...
          <tr>
            <td>&nbsp;</td>
            <td height="22"><input name="bbh_per_equipe" type="checkbox" id="bbh_per_equipe" value="1" <?php if($row_perfil['bbh_per_equipe']>0){echo "checked";} ?> />
              <img src="/e-solution/servicos/bbhive/images/ger-usuarios-16px.gif" alt="" width="16" height="16" align="absmiddle" /> Equipe</td>
            <td><input name="bbh_per_central_indicios" type="checkbox" id="bbh_per_central_indicios" value="1" <?php if($row_perfil['bbh_per_central_indicios']>0){echo "checked";} ?> />
          ...
          <tr>
            <td>&nbsp;</td>
            <td height="22"><input name="bbh_per_corp" type="checkbox" id="bbh_per_corp" value="1"  <?php if($row_perfil['bbh_per_corp']>0){echo "checked";} ?> />
            ...
            <td><input name="bbh_per_pub" type="checkbox" id="bbh_per_pub" value="1"  <?php if($row_perfil['bbh_per_pub']>0){echo "checked";} ?> />
              <img src="/e-solution/servicos/bbhive/images/cadeado_off.gif" alt="" width="16" height="16" align="absmiddle" /> Sem acesso publico</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td height="22"><input name="bbh_per_peoplerank" type="checkbox" id="bbh_per_peoplerank" value="1"  <?php if($row_perfil['bbh_per_peoplerank']>0){echo "checked";} ?> />
              <img src="/e-solution/servicos/bbhive/images/peoplerank.gif" alt="" width="16" height="16" align="absmiddle" /> Peoplrank</td>
            <td><input name="bbh_per_bi" type="checkbox" id="bbh_per_bi" value="1"  <?php if($row_perfil['bbh_per_bi']>0){echo "checked";} ?> />
              <img src="/e-solution/servicos/bbhive/images/bi.gif" alt="" width="16" height="16" align="absmiddle" /> BI</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td height="22"><input name="bbh_per_geo" type="checkbox" id="bbh_per_geo" value="1"  <?php if($row_perfil['bbh_per_geo']>0){echo "checked";} ?> />
      ...
      <tr>
        ...
        <td >&nbsp;
        <textarea class="formulario2" name="bbh_per_observacao" id="bbh_per_observacao" cols="44" rows="7"><?php if(isset($_POST['bbh_per_observacao'])){ echo $_POST['bbh_per_observacao']; }else{echo $row_perfil['bbh_per_observacao'];}?></textarea></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td height="35">&nbsp;<input type="button" name="button2" id="button2" value="Cancelar" class="button" onClick="showHome('includes/home.php','conteudoGeral', 'perfil/index.php?perfil=1&amp;menuEsquerda=1|perfis/index.php','menuEsquerda|colCentro');" /> 
          <input type="button" name="button" id="button" value="Editar" class="button" onClick="return validaForm('editaPerfil', 'bbh_per_nome|Preencha o nome do perfil', document.getElementById('acaoForm').value)"><input name="acaoForm" id="acaoForm" type="hidden" value="<?php echo $acao; ?>" /></td>
      </tr>
  ...
  <input type="hidden" name="MM_update" value="editaPerfil" />
</form>