...
if(isset($_POST['MM_insert'])){
	  $deleteSQL = "DELETE FROM bbh_tipo_indicio WHERE bbh_tip_codigo = ".$_POST['bbh_tip_codigo'];
	  list($Result1, $rows, $totalRows_dep) = executeQuery($bbhive, $database_bbhive, $deleteSQL);
...
foreach($_GET as $indice => $valor){
	...
	//Ação FORM
	$TimeStamp 		= time();
	$homeDestino	= '/e-solution/servicos/bbhive/departamentos/tipos_indicios/excluir.php?Ts='.$TimeStamp;
...
background="/e-solution/servicos/bbhive/images/barra_horizontal.jpg" class="verdana_11_bold"><img src="/e-solution/servicos/bbhive/images/tipos_indicios.gif" width="16" height="16" border="0" align="absmiddle" />
      ...
      Exclus&atilde;o de tipos de ind&iacute;cios</td>
...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" style="border:#E1E1E1 solid 1px;margin-bottom:2px;" class="legandaLabel11">
              <tr>
                <td height="25" colspan="2" style="border-bottom:#E1E1E1 solid 1px;">
                  <table width="100%" style="background:#DFEFDF; border:#FFF solid 1px; height:100%;" class="legandaLabel11">
                    <tr>
                        <td align="left">&nbsp;<img src="/corporativo/servicos/bbhive/images/detalhesIndicios.gif" width="16" height="16" align="absbottom">&nbsp;<strong style="color:#339900">Exclus&atilde;o</strong></td>
                    </tr>
                  </table>  
                </td>
              </tr>
              ...
              <tr>
                ...
                <td height="22" align="left">
						<select name="bbh_dep_codigo" id="bbh_dep_codigo" class="verdana_9" disabled="disabled">
              ...
              <tr>
                ...
                <td width="452" align="left" valign="middle"><input name="bbh_tip_nome" type="text" class="back_Campos" id="bbh_tip_nome" value="<?php echo $row_tipo['bbh_tip_nome']; ?>" size="45" maxlength="255" disabled="disabled"></td>
              </tr>
              <tr>
                <td height="22" align="right" valign="middle">T&iacute;tulo do campo1 :&nbsp;</td>
                <td align="left" valign="middle"><input name="cp1" type="text" class="back_Campos" id="cp1" value="<?php echo $cp1; ?>" size="45" maxlength="255" disabled="disabled"></td>
              </tr>
              <tr>
                <td height="22" align="right" valign="middle">T&iacute;tulo do campo2 :&nbsp;</td>
                <td align="left" valign="middle"><input name="cp2" type="text" class="back_Campos" id="cp2" value="<?php echo $cp2; ?>" size="45" maxlength="255" disabled="disabled"></td>
              </tr>
              <tr>
                <td width="141" height="22" align="right" valign="middle">&nbsp;</td>
                <td width="452" align="left" valign="middle"><input name="bbh_tip_ativo" type="checkbox" id="bbh_tip_ativo" <?php if($row_tipo['bbh_tip_ativo']=='1'){ echo "checked"; } ?> disabled="disabled">
                Publicado</td>
              </tr>
              <tr>
                <td height="60" align="right" valign="top">Descri&ccedil;&atilde;o do tipo :&nbsp;</td>
                <td height="60" align="left" valign="top"><textarea class="formulario2" name="bbh_tip_descricao" id="bbh_tip_descricao" cols="50" rows="3" disabled="disabled"><?php echo $row_tipo['bbh_tip_descricao']; ?></textarea></td>
  </tr>
              <tr>
                <td width="141" height="22" align="right" valign="middle">&nbsp;</td>
                <td width="452" align="right" valign="middle"><input type="button" name="button" id="button" value="Excluir definitivamente" class="back_input" onclick="return validaForm('cadastraTipo', 'bbh_tip_nome|Preencha o título do indício', document.getElementById('acaoForm').value)">
                &nbsp;</td>
              </tr>
              </table>
