...
";
$aplicacoes = mysqli_query($policy, $query_aplicacoes) or die(mysql_error());
$row_aplicacoes = mysqli_fetch_assoc($aplicacoes);
$totalRows_aplicacoes = mysqli_num_rows($aplicacoes);
