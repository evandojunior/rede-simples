...
foreach($_GET as $indice=>$valor){
	...
	$query_Fluxos = "select bbh_mod_ati_observacao from bbh_atividade inner join bbh_modelo_atividade on bbh_atividade.bbh_mod_ati_codigo = bbh_atividade.bbh_mod_ati_codigo Where bbh_atividade.bbh_ati_codigo = $bbh_ati_codigo";
...
?><table width="420" border="0" align="center" cellpadding="0" cellspacing="0" style="background:#FFF;border:#A0AFC3 solid 1px; ">
  ...
  <tr>
    ...
    <div style="margin:10px;"><?php echo nl2br($row_Fluxos['bbh_mod_ati_observacao']); ?></div>
    </td>
  </tr>
  </table>
