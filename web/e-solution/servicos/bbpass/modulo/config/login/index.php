...
$homeDestino	= '/e-solution/servicos/bbpass/modulo/config/login/index.php?bbp_adm_loc_codigo='.$_GET['bbp_adm_loc_codigo'];
...
<table width="765" border="0" align="left" cellpadding="0" cellspacing="0" style="margin-top:5px;margin-bottom:10px;">
  <tr>
    ...
    <div style="float:right" class="fonteDestaque">
   	  <a href="/e-solution/servicos/bbpass/modulo/config/login/avancado/index.php?lock=<?php echo $_GET['bbp_adm_loc_codigo']; ?>"><img src="/e-solution/servicos/bbpass/images/engrenagem.gif" width="17" height="16" border="0" align="absmiddle"> Avançado</a> </div>
    </td>
	 	...
	 	?>
          <tr>
            ...
            <td width="22" height="25" align="center" style="border-bottom:#EEEEEE solid 1px;">
            	<a href="#" rev="/e-solution/servicos/bbpass/modulo/config/login/edita.php?bbp_adm_loc_codigo=<?php echo $_GET['bbp_adm_loc_codigo']; ?>&bbp_adm_lock_log_codigo=<?php echo $row_login['bbp_adm_lock_log_codigo']; ?>" onclick="enviaURL(this);" title="Editar este usuário">
                	<img src="/e-solution/servicos/bbpass/images/btn_editar.gif" width="15" height="16" border="0" align="absmiddle">
                </a>
            </td>
            <td width="22" height="25" align="center" style="border-bottom:#EEEEEE solid 1px;">
            	<a href="#" rev="/e-solution/servicos/bbpass/modulo/config/login/excluir.php?bbp_adm_loc_codigo=<?php echo $_GET['bbp_adm_loc_codigo']; ?>&bbp_adm_lock_log_codigo=<?php echo $row_login['bbp_adm_lock_log_codigo']; ?>" onclick="enviaURL(this);" title="Excluir usuário" >
