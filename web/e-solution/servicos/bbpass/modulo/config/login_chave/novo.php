...
if(isset($_POST['atualiza'])){
		...
		$Evento="Cadastrou o usuário ".$login->bbp_adm_lock_log_chave." no módulo ".$modulo->nomeAplicacao($database_bbpass, $bbpass, $_POST['bbp_adm_loc_codigo']);
		EnviaPolicy($Evento);
	  //=======================================
...
<form action="/e-solution/servicos/bbpass/modulo/config/login_chave/novo.php" method="post" id="atualizaPerfil" name="atualizaPerfil">
  ...
  <tr>
    ...
    <td height="25"><input name="bbp_adm_lock_log_chave" type="text" class="back_Campos" id="bbp_adm_lock_log_chave" size="40"/></td>
    </tr>
  <tr>
  ...
  <tr>
    ...
    <input name="cadastrar" onclick="voltarURL('/e-solution/servicos/bbpass/modulo/config/login_chave/index.php?bbp_adm_loc_codigo=<?php echo $_GET['bbp_adm_loc_codigo']; ?>');" type="button" class="botaoVoltar back_input" id="cadastrar" value="&nbsp;&nbsp;&nbsp;Cancelar cadastro"/>
  <?php
  	$url 			= "/e-solution/servicos/bbpass/modulo/config/login_chave/novo.php?verificaRepetido=true&bbp_adm_lock_log_chave=";
  	$tag 			= "resultado";
