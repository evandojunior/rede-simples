...
$quando = mysqli_query($policy, $query_quando) or die(mysql_error());
$row_quando = mysqli_fetch_assoc($quando);
$totalRows_quando = mysqli_num_rows($quando);
...
if(!isset($_SESSION['mesesCompletos'])){
	...
	}while($row_quando = mysqli_fetch_assoc($quando));
