 ...
 <?php do{ 
	...
	<div>
    	<div style="display:inline">
        	<a href="#@" onClick=" return elementoArvore('Tagfilho_<?php echo $CodigoPai; ?>','/e-solution/servicos/bbhive/fluxos/modelosFluxos/arvore.php?timeStamp=<?php echo time(); ?>&nivelGrupo=<?php echo $Conta; ?><?php echo $complemento; ?>');">
