...
include($_SESSION['caminhoFisico']."/corporativo/servicos/bbhive/includes/autentica.php");
	...
	//--
	$_SESSION['arquivos_externos'] = true;
	//--
	$barra = '<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="verdana_11">
			  <tr>
				<td height="23" align="right" bgcolor="#FFFFFF"><a href="#@" onClick="window.top.document.getElementById(\'carregaTudo\').innerHTML = \'&nbsp;\';"><span style="color:#F60"><strong>Fechar janela de anexos</strong></span>&nbsp;<img src="/corporativo/servicos/bbhive/images/painel/fechar.gif" width="18" height="18" border="0" align="absmiddle" /></a></td>
			  </tr>
			</table>';
	//--
	...
	$tipoArquivo 	= '{title : "Somente arquivos PDF", extensions : "pdf"}';
	//--
