...
//----------------------------------------------------------------------
 ...
 inner join bbh_departamento d on d.bbh_dep_codigo = t.bbh_dep_codigo
	...
	//--
	$query_tipo = "select * from bbh_tipo_indicio where bbh_dep_codigo=".$row_dpto['bbh_dep_codigo']." and bbh_tip_ativo='1' order by 2 ASC";
	...
	$acao = "OpenAjaxPostCmd('/servicos/bbhive/protocolos/indicios/cadastrar.php','loadMsg','solicitacao','Aguarde carregando dados...','loadMsg','1','".$TpMens."');";
	
	$remove = "OpenAjaxPostCmd('/servicos/bbhive/protocolos/indicios/cadastrar.php','loadMsg','removeRegistro','Aguarde carregando dados...','loadMsg','1','".$TpMens."');";
	
	$formulario = "OpenAjaxPostCmd('/servicos/bbhive/protocolos/indicios/formulario.php','carregaDuplicado','solicitacao','Aguarde carregando dados...','carregaDuplicado','1','".$TpMens."');";
...
?><form id="solicitacao" name="solicitacao"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-bottom:15px;">
  ...
  <tr>
    <td height="80" style="border-left:#cccccc solid 1px; border-right:#cccccc solid 1px; border-bottom:#cccccc solid 1px;"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td height="20" align="left" bgcolor="#F5F5F5" class="legandaLabel11"><strong>Tipo de <?php echo $_SESSION['componentesNome']; ?>:</strong>
	...
	?>
      ...
      <tr>
        <td height="20" align="left" id="carregaDuplicado" class="legandaLabel11">&nbsp;</td>
      </tr>
      <?php } else { ?>
      <tr>
