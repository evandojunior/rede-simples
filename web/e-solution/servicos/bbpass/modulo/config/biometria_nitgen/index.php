...
$homeDestino	= '/e-solution/servicos/bbpass/modulo/config/biometria_nitgen/index.php?bbp_adm_loc_codigo='.$_GET['bbp_adm_loc_codigo'];

//busca registros
$compPaginacao 			= " LIMIT $Inicio,$nElements";

						  $biometria->consultaBiometriaN($database_bbpass, $bbpass, $compPaginacao);
$row_biometria		   	= $biometria->row_Bio;
$totalRows_biometria 	= $biometria->totalRows_Bio;

$pages 			= ceil($biometria->totalBiometriaN($database_bbpass, $bbpass)/$nElements);
/*============================PAGINAÇÃO==========================================*/
    ...
    <td height="410" colspan="3" align="left" valign="top" bgcolor="#FFFFFF" class="legendaLabel14" style="border-left:#DCDFE1 solid 1px;border-right:#DCDFE1 solid 1px;border-bottom:#DCDFE1 solid 1px;">
        <table width="764" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="423" class="fundoTitulo legendaLabel12"><strong>Email do usu&aacute;rio</strong></td>
            <td colspan="4" align="center" class="fundoTitulo legendaLabel11"><a href="#@" title="Clique para cadastrar um novo usuário" rev="/e-solution/servicos/bbpass/modulo/config/login/novo.php?bbp_adm_loc_codigo=<?php echo $_GET['bbp_adm_loc_codigo']; ?>" onclick="enviaURL(this);"><img src="/e-solution/servicos/bbpass/images/btn_novo.gif" width="16" height="16" border="0" align="absbottom">&nbsp;Novo</a></td>
          </tr>
          <tr>
     ...
     <?php if($totalRows_biometria>0){ 
	 	...
	 	?>
          <tr>
            <td height="25" style="border-bottom:#EEEEEE solid 1px;" class="legendaLabel11">&nbsp;<img src="/e-solution/servicos/bbpass/images/table.gif" width="16" height="16" border="0" align="absmiddle">&nbsp;<?php echo $row_biometria['bbp_adm_lock_log_nome']; ?></td>
            <td height="25" style="border-bottom:#EEEEEE solid 1px;" class="legendaLabel11">&nbsp;<?php echo $row_biometria['bbp_adm_lock_log_email']; ?></td>
            ...
            <?php if($row_biometria['bbp_adm_lock_bio_codigo']>0){ ?>
                	<img src="/e-solution/servicos/bbpass/images/biometria.gif" width="17" height="19" border="0" align="absmiddle" title="Este registro já possuí identificação biométrica">
            <?php } else { ?>  
             <a href="#@" rev="/e-solution/servicos/bbpass/modulo/config/biometria_nitgen/novo.php?bbp_adm_loc_codigo=<?php echo $_GET['bbp_adm_loc_codigo']; ?>&bbp_adm_lock_log_codigo=<?php echo $row_biometria['bbp_adm_lock_log_codigo']; ?>" onclick="enviaURL(this);">  
				<img src="/e-solution/servicos/bbpass/images/biometriaOFF.gif" width="17" height="19" border="0" align="absmiddle" title="Este registro não tem identificação biométrica, clique para adicionar">
             </a>   
            <?php } ?>
            </td>
            <td width="22" height="25" align="center" style="border-bottom:#EEEEEE solid 1px;">
        <?php if($row_biometria['bbp_adm_lock_log_codigo']>0){ ?>
            	<a href="#@" rev="/e-solution/servicos/bbpass/modulo/config/biometria_nitgen/index.php?bbp_adm_loc_codigo=<?php echo $_GET['bbp_adm_loc_codigo']; ?>&bbp_adm_lock_bio_codigo=<?php echo $row_biometria['bbp_adm_lock_bio_codigo']; ?>&exBio=true" onclick="if(confirm('Tem certeza que deseja excluir este Registro?\nClique no Ok em caso de confirmação.')){enviaURL(this);}" title="Excluir este registro" >
                	<img src="/e-solution/servicos/bbpass/images/btn_excluir.gif" width="14" height="16" border="0" align="absmiddle">
                </a>
            <?php } else { ?>    
            <img src="/e-solution/servicos/bbpass/images/btn_excluirOFF.gif" width="14" height="16" border="0" align="absmiddle" title="Este registro não pode ser excluido, pois não tem identificação biométrica">
            <?php } ?>
            </td>
          </tr>
