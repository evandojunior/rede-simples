<?php
				 ...
				 r.bbh_usu_codigo as cdremetente
				  ...
				  from bbh_mensagens as m
					...
					inner join bbh_usuario as d on m.bbh_usu_codigo_destin = d.bbh_usu_codigo
					 Where m.bbh_usu_codigo_remet = ".$_SESSION['usuCod']." AND m.bbh_men_exclusao_remetente ='1'
					       $SQLAjuste
				UNION 
				...
				select 
				 ...
				 r.bbh_usu_codigo as cdremetente
				  ...
				  from bbh_mensagens as m
					inner join bbh_usuario as r on m.bbh_usu_codigo_remet  = r.bbh_usu_codigo
					inner join bbh_usuario as d on m.bbh_usu_codigo_destin = d.bbh_usu_codigo
					 Where m.bbh_usu_codigo_destin = ".$_SESSION['usuCod']." AND m.bbh_men_exclusao_destinatario ='1'
					        $SQLAjuste
				) as mx
	...
	$query_contadormsg = "SELECT 
							bbh_usu_codigo_destin 
								FROM bbh_mensagens 
									WHERE 
(bbh_mensagens.bbh_usu_codigo_destin = ".$_SESSION['usuCod']." AND bbh_mensagens.bbh_men_exclusao_destinatario = '1' ) 
OR 
(bbh_mensagens.bbh_usu_codigo_remet = ".$_SESSION['usuCod']." AND bbh_mensagens.bbh_men_exclusao_remetente = '1') 
	 $SQLAjuste";
