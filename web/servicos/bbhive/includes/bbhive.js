...
function windowOpen(value,titulo)
{
	...
	var _win = window.open('','Arvore','width=500,height=500,scrolling=0');
		...
		if(!_win)
		{
			alert('A janela não pode ser aberta, talvês você esteja usando um bloqueador de POP-UP. Desabilite-o e tente novamente!');
			return false;
		}
...
function descobreParentes(maskara, container)
{
	...
	DivCcontainer.innerHTML = 'Aguarde, montando árvore...';
