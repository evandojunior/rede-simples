...
<?PHP }else{ ?>
//escondeBloco('corpoTarefa','fluxo', 'titulo', '&nbsp;Fluxo', '/corporativo/servicos/bbhive/fluxo/index2.php?bbh_ati_codigo=<?php echo $_GET['bbh_ati_codigo']; ?>&bbh_flu_codigo=<?PHP echo $bbh_flu_codigo;?>&exibeIndicios=true');
showHome('includes/completo.php','conteudoGeral', 'perfil/index.php?perfil=1&amp;tarefas=2|tarefas/acao/regra.php?bbh_ati_codigo=<?php echo $_GET['bbh_ati_codigo']; ?>&amp;1=1','menuEsquerda|colPrincipal');
<?PHP } ?>
</var>