...
$quando_dia = mysql_query($query_quando_dia, $policy) or die(mysql_error());
$row_quando_dia = mysql_fetch_assoc($quando_dia);
$totalRows_quando_dia = mysql_num_rows($quando_dia);
...
<?php do { ?>
  ...
  <?php } while ($row_quando_dia = mysql_fetch_assoc($quando_dia)); ?>
<tr>
  <td colspan="3">&nbsp;</td>
</tr>
</table>
<?php
mysql_free_result($quando_dia);
?>