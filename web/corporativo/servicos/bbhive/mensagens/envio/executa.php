...
if(isset($_POST['MM_EnviaMensagem'])){
	...
	$bbh_men_assunto		= mysqli_fetch_assoc($_POST['bbh_men_assunto']);
	$bbh_men_mensagem		= mysqli_fetch_assoc($_POST['bbh_men_mensagem']);
...
<?php if(isset($_POST['voltaFluxo'])){?>
showHome('includes/home.php','conteudoGeral','perfil/index.php?perfil=1&fluxo=1|fluxo/index.php?menu=1&bbh_flu_codigo=<?php echo $bbh_flu_codigo; ?>&exibeMensagem=true&caixaEntrada=true|includes/colunaDireita.php?fluxo=1&equipeFluxos=1&bbh_flu_codigo=<?php echo $bbh_flu_codigo; ?>&exibeMensagem=true&arquivosFluxos=1&relatorios=1','menuEsquerda|colCentro|colDireita');
<?php } else{ ?>
showHome('includes/home.php','conteudoGeral', 'perfil/index.php?perfil=1&mensagens=1|mensagens/index.php?&caixaEntrada=true|includes/colunaDireita.php?fluxosDireita=1&equipeMensagens=1&eventos=1','menuEsquerda|colCentro|colDireita')
<?php } ?>
</var>