...
if ( isset ($_POST['pol_pol_codigo']) )  {

 $goTo = "passo3.php?pol_pol_codigo=".$_POST['pol_pol_codigo'];
  if (isset($_SERVER['QUERY_STRING'])) {
    $goTo .= (strpos($goTo, '?')) ? "&" : "?";
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
	...
	$validaaplicacao = mysql_query($query_validaaplicacao, $policy) or die(mysql_error());
	$row_validaaplicacao = mysql_fetch_assoc($validaaplicacao);
	$totalRows_validaaplicacao = mysql_num_rows($validaaplicacao);
...
function validaForm(){
	var cod_politica = form1.pol_pol_codigo.value;
	if (cod_politica<0){
		window.alert("Selecione uma política");
        ...
        <tr>
              ...
              <tr>
                ...
                <td height="30" align="left"><label>
                  ...
                  <select class="formulario2" name="pol_pol_codigo" id="pol_pol_codigo">
                    <option value="-1" selected="selected">Selecione uma política </option>
                  	<?php do { ?>  
                    <option value="<?php echo $row_strPolitica['pol_pol_codigo'] ?>"><?php echo $row_strPolitica['pol_pol_titulo']; ?></option>
                   <?php }  while ( $row_strPolitica = mysql_fetch_assoc($strPolitica) );  ?>
                  </select>
                </label></td>
              </tr>
              <tr>
            ...
            ?>                </td>
              ...
              <tr>
                ...
                <input name="button" type="button" class="button" id="button" value="Avan&ccedil;ar" onclick="validaForm();" /></td>
            </tr>
              <tr>
