...
$MM_authorizedUsers 	= "-1,684";//SOMENTE PARA POLICY - E-SOLUTION
...
if (!((isset($_SESSION['MM_Policy_name'])) && (isAuthorized("",$MM_authorizedUsers, $_SESSION['MM_Policy_name'], $_SESSION['MM_Policy_Group'])))) {   
  $MM_qsChar = "?";
