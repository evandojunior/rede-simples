...
if(isset($_SESSION["urlAnteriorAdm"])){

		$_SESSION['urlEnviaAdm'] = $_SESSION['urlAnteriorAdm'];
		$_SESSION['exPaginaAdm'] = $_SESSION['exAnteriorAdm']	;
...
<script>
function bbpass(){
	parent.frames['login'].location ="<?php echo $_SESSION['EndURL_BBPASS']; ?>/servicos/bbpass/modulos_autenticacao/autenticaRemoto.php?<?php echo "idApl=".$idAplicacaoBBPASS_Administrativo; ?>";
}
...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center" valign="middle"><table width="420" border="0" cellpadding="0" cellspacing="0" bgcolor="#F1F3F8" class="borderAlljanela">
      <tr>
        <td height="90" background="/datafiles/servicos/bbhive/e-solution/imagens/sistema/cabecalho_login.jpg">&nbsp;</td>
      </tr>
      <tr>
          <td height="25" class="verdana_11" align="right" bgcolor="#FFFFFF">
         <label>	
            	<a href="/servicos/bbhive/logoutRegeneration.php?abandona=sim"><span class="color">Acesso P&uacute;blico</span></a>
         </label>
         |
