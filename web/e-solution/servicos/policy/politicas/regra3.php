...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertSQL = sprintf("INSERT INTO pol_politica (pol_pol_titulo, pol_usu_identificacao, pol_pol_criacao, pol_pol_descricao, pol_apl_codigo, pol_pol_xml) VALUES (%s, %s, %s, %s, %s, '$conteudo')",
                       GetSQLValueString($policy, $_POST['pol_pol_titulo'], "text"),
                       GetSQLValueString($policy, $_POST['pol_usu_identificacao'], "text"),
                       GetSQLValueString($policy, $_POST['pol_pol_criacao'], "date"),
					   GetSQLValueString($policy, $_POST['pol_pol_descricao'], "text"),
                       GetSQLValueString($policy, $_POST['pol_apl_codigo'], "text"));
