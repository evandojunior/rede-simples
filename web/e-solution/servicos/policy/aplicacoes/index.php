...
$infoaplicacoes = mysqli_query($policy, $query_infoaplicacoes) or die(mysql_error());
$row_infoaplicacoes = mysqli_fetch_assoc($infoaplicacoes);
$totalRows_infoaplicacoes = mysqli_num_rows($infoaplicacoes);
?>
...
if($totalRows_infoaplicacoes>0){ ?>
            ...
            <tr>
              ...
              <?php } while ($row_infoaplicacoes = mysqli_fetch_assoc($infoaplicacoes)); ?>
<?php } else { ?>
...
<?php
mysqli_free_result($infoaplicacoes);
?>