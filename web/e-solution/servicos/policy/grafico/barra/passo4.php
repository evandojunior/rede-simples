              ...
              <tr>
                ...
                <td height="30" align="left"><label>
                  ...
                  <select class="formulario2" name="pol_pol_codigo" id="pol_pol_codigo" disabled="disabled">
                    ...
                    <?php do { ?>
                    <option value="<?php echo $row_strPolitica['pol_pol_codigo']; ?>" <?php if ( $row_strPolitica['pol_pol_codigo'] == $_GET['pol_pol_codigo']) { echo 'selected="selected"'; }  ?> > <?php echo $row_strPolitica['pol_pol_titulo']; ?> </option>
                    <?php
