...
include($_SESSION['caminhoFisico']."/e-solution/servicos/bbhive/includes/functions.php");
	...
	$homeDestino	= '/e-solution/servicos/bbhive/fluxos/modelosFluxos/modelosAtividades/edita.php';
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "cadastraMod")) {
	...
	$novocod	= $_POST['bbh_mod_ati_codigo'];
	$campo		=", bbh_mod_ati_mecanismo='0'";
	
	if(isset($_POST['bbh_mod_ati_mecanismo'])){
		$campo = ", bbh_mod_ati_mecanismo='1'";
	}

	$inicio	= ", bbh_mod_atiInicio='0'";
	if(isset($_POST['bbh_mod_atiInicio'])){
		$inicio	= ", bbh_mod_atiInicio='1'";
	}
	
	$fim	= ", bbh_mod_atiFim='0'";
	if(isset($_POST['bbh_mod_atiFim'])){
		$fim	= ", bbh_mod_atiFim='1'";
	}
	
	$relatorio= ", bbh_mod_ati_relatorio='0'";
	if(isset($_POST['bbh_mod_ati_relatorio'])){
		$relatorio= ", bbh_mod_ati_relatorio='1'";
	}

	$query_validacao = "SELECT bbh_mod_ati_nome FROM bbh_modelo_atividade WHERE bbh_mod_ati_nome = '$novonome' and bbh_mod_flu_codigo=".$_POST['bbh_mod_flu_codigo']." and bbh_mod_ati_codigo<>".$_POST['bbh_mod_ati_codigo'];
	...
	if($totalRows_validacao==0){
	 $updateSQL = "UPDATE bbh_modelo_atividade SET bbh_per_codigo=".$_POST['bbh_per_codigo'].", bbh_mod_ati_nome='".($_POST['bbh_mod_ati_nome'])."', bbh_mod_ati_inicio=".$_POST['bbh_mod_ati_inicio'].", bbh_mod_ati_duracao=".$_POST['bbh_mod_ati_duracao'].", bbh_mod_ati_icone='".$_POST['bbh_mod_ati_icone']."', bbh_mod_ati_observacao='".($_POST['bbh_mod_ati_observacao'])."'   $campo $inicio $fim $relatorio WHERE bbh_mod_ati_codigo = $novocod";
...
<var style="display:none">txtSimples('tagPerfil', 'Edi&ccedil;&atilde;o de modelos de atividades')</var>
...
<form name="cadMod" id="cadMod" style="margin-top:-1px;">
    <table width="595" border="0" align="left" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      <tr>
        <td height="24" background="/e-solution/servicos/bbhive/images/cabAtiv.gif" class="legandaLabel11"><strong>&nbsp;Edi&ccedil;&atilde;o de modelo de atividade</strong></td>
      </tr>
      <tr>
    ...
    ?>
              ...
              <tr>
                ...
                <td><input class="back_Campos" name="bbh_mod_ati_nome" type="text" id="bbh_mod_ati_nome" size="60" style="height:17px;border:#E3D6A4 solid 1px;" value="<?php echo $row_modAti['bbh_mod_ati_nome']; ?>"/></td>
              </tr>
            </table></td>
          </tr>
    ...
    ?></tr>
            ...
            <td width="304" valign="top" style="border-left:#CCCCCC solid 1px;"><table width="294" border="0" align="center" cellpadding="0" cellspacing="0"class="legandaLabel11">
              ...
              <tr>
                <td height="20" valign="middle" background="/e-solution/servicos/bbhive/images/cabFlux.gif">&nbsp;
                  <label>
                  <input type="checkbox" name="bbh_mod_atiInicio" id="bbh_mod_atiInicio" <?php if($row_modAti['bbh_mod_atiInicio']=='1'){ echo 'checked="checked"'; }  ?>/>
                  </label>
              ...
              <tr>
                <td height="20" valign="middle" background="/e-solution/servicos/bbhive/images/cabFlux.gif">&nbsp;<label>
                  <input type="checkbox" name="bbh_mod_atiFim" id="bbh_mod_atiFim" <?php if($row_modAti['bbh_mod_atiFim']=='1'){ echo 'checked="checked"'; }  ?>/>
                </label>
                  Atividade Final</td>
              </tr>
              <tr>
              ...
              <tr>
                <td height="20" valign="middle" background="/e-solution/servicos/bbhive/images/cabFlux.gif">&nbsp;<label>
                  <input type="checkbox" name="bbh_mod_ati_relatorio" id="bbh_mod_ati_relatorio" <?php if($row_modAti['bbh_mod_ati_relatorio']=='1'){ echo 'checked="checked"'; }  ?>/>
                </label>
          ...
          <tr>
            <td height="24" colspan="2" align="center"><textarea class="back_Campos" name="bbh_mod_ati_observacao" id="bbh_mod_ati_observacao" cols="110" rows="7" style="border:#E3D6A4 solid 1px;"><?php echo $row_modAti['bbh_mod_ati_observacao']; ?></textarea></td>
          </tr>
          <tr>
            <td height="5" colspan="2"></td>
          </tr>
          <tr>
            <td height="24" colspan="2" class="legandaLabel11"><input type="checkbox" name="bbh_mod_ati_mecanismo" id="bbh_mod_ati_mecanismo" style="margin-left:8px;" <?php if($row_modAti['bbh_mod_ati_mecanismo']=='1'){ echo 'checked="checked"'; }  ?>/>
    Sele&ccedil;&atilde;o de profissionais automatica.
        	...
        	<div style="float:right; margin-top:-15px;">
                <input name="button" type="button" class="back_input" id="button" value="Cancelar"  onClick="LoadSimultaneo('perfil/index.php?perfil=2|fluxos/modelosFluxos/modelosAtividades/index.php?bbh_mod_flu_codigo=<?php echo $_GET['bbh_mod_flu_codigo']; ?>','menuEsquerda|conteudoGeral');" style="cursor:pointer; background-image:url(/e-solution/servicos/bbhive/images/search.gif); color:#FFFFFF"/>
                                               <input name="insereModelo" type="button" class="back_input" id="insereModelo" value="Atualizar modelo" style="cursor:pointer; background-image:url(/e-solution/servicos/bbhive/images/search.gif); color:#FFFFFF" onclick="return validaForm('cadMod', 'bbh_per_codigo|Escolha um perfil, bbh_mod_ati_nome|Descreva o nome deste modelo, bbh_mod_ati_inicio|Selecione o tempo para inicio da atividade, bbh_mod_ati_duracao|Selecione o tempo de dura&ccedil;&atilde;o desta atividade' ,  document.getElementById('acaoForm').value)"/>&nbsp;&nbsp;&nbsp;            </div>    </td>
          </tr>
          <tr>
            <td height="5" colspan="2"></td>
          </tr>
