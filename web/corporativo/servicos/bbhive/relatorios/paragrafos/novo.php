...
include($_SESSION['caminhoFisico']."/corporativo/servicos/bbhive/includes/functions.php");
	...
	$homeDestino	= '/corporativo/servicos/bbhive/relatorios/paragrafos/novo.php';
	
	$acao = "OpenAjaxPostCmd('".$homeDestino."','cadastraModelo','formPar','Cadastrando dados...','cadastraModelo','1','".$TpMens."');";
...
if(isset($_POST['insertPar'])){//insere parágrafo
	...
	if($totalRows_validacao==0){
	  $insertSQL = "INSERT INTO bbh_modelo_paragrafo (bbh_mod_par_nome, bbh_mod_par_titulo, bbh_mod_par_paragrafo, bbh_mod_flu_codigo, bbh_usu_autor, bbh_mod_par_privado, bbh_mod_par_momento) VALUES ('".$bbh_mod_par_nome."', '".$bbh_mod_par_titulo."', '".$bbh_mod_par_paragrafo."', ".$bbh_mod_flu_codigo.", ".$_SESSION['usuCod'].", '1', '".$bbh_mod_par_momento."')";
...
<script type="text/javascript">
	...
	$_SESSION['textoParAutor']	= $_SESSION['usuNome'];
?><var style="display:none">txtSimples('tagPerfil', 'Cadastro de par&aacute;grafos')</var><form name="formPar" id="formPar" style="width:600px;"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="verdana_11" style="margin-top:-10px;">
  <tr>
...
<table align="center" width="590" height="30px" border="0" cellspacing="0" cellpadding="0" style="margin-top:5px;">    
<tr>
  <td width="600" height="490" align="left" valign="middle" class="verdana_12 color">
<iframe src="/corporativo/servicos/bbhive/relatorios/paragrafos/editorTexto.php?bbh_mod_flu_codigo=<?php echo $_GET['bbh_mod_flu_codigo']; ?>&bbh_tip_flu_codigo=<?php echo $_GET['bbh_tip_flu_codigo']; ?>&arquivo=novo&acao=insertPar" name="editor" id="editor" width="100%" height="100%" allowtransparency="1" frameborder="0" />
  </td>  
</tr>
<tr>
  <td height="15" align="right" valign="middle" class="verdana_12 color">&nbsp;</td>
</tr>
</table>
        </form>