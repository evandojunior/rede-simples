			...
			if($tamanho > 50)
			{
				...
				break;
					...
					if($valorPadrao != "")
					{
						...
						elseif($row_campos_detalhamento['bbh_cam_ind_nome'] == 'bbh_ind_confiabilidade_fonte')
						{
						...
						elseif($row_campos_detalhamento['bbh_cam_ind_nome'] == 'bbh_ind_veracidade_informacao')
						{
