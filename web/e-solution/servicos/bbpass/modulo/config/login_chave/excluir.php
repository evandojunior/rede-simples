...
if(isset($_POST['atualiza'])){
		...
		$excluido = $login->bbp_adm_lock_log_chave;
...
<form action="/e-solution/servicos/bbpass/modulo/config/login_chave/excluir.php" method="post" id="atualizaPerfil" name="atualizaPerfil">
  ...
  <tr>
    ...
    <td height="25"><input name="bbp_adm_lock_log_chave" type="text" class="back_Campos" id="bbp_adm_lock_log_chave" value="<?php echo $login->bbp_adm_lock_log_chave; ?>" size="40" disabled="disabled"/></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <input name="cadastrar" onclick="voltarURL('/e-solution/servicos/bbpass/modulo/config/login_chave/index.php?bbp_adm_loc_codigo=<?php echo $_GET['bbp_adm_loc_codigo']; ?>');" type="button" class="botaoVoltar back_input" id="cadastrar" value="&nbsp;&nbsp;&nbsp;Cancelar exclus&atilde;o"/>
...
/*===============================INICIO AUDITORIA POLICY=========================================*/
	...
	$Evento="Acessou a página de exclusão do usuário ".$login->bbp_adm_lock_log_chave." do módulo ".$modulo->nomeAplicacao($database_bbpass, $bbpass, $_GET['bbp_adm_loc_codigo']).".";
	EnviaPolicy($Evento);
/*===============================FIM AUDITORIA POLICY============================================*/
?>