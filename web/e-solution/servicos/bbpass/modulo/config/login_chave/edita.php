...
$login = new LoginChave();//instância classe
$modulo 				= new Modulo();

//verifica usuário com o mesmo nome
if(isset($_GET['verificaRepetido'])){
	$login->bbp_adm_lock_log_chave	= $_GET['bbp_adm_lock_log_chave'];
...
if(isset($_POST['atualiza'])){
		...
		$login->bbp_adm_lock_log_chave	= $_POST['bbp_adm_lock_log_chave'];
		...
		$editado = $login->bbp_adm_lock_log_chave;
...
/*===============================FIM AUDITORIA POLICY============================================*/
		...
		$login->atualizaDados($database_bbpass, $bbpass, $complSenha);//UPDATE
		  ...
		  $urlRetorno = "/e-solution/servicos/bbpass/modulo/config/login_chave/index.php?bbp_adm_loc_codigo=".$_POST['bbp_adm_loc_codigo'];//retorno após procedimento de manipulação de banco
		  echo "<var style='display:none'>
...
<form action="/e-solution/servicos/bbpass/modulo/config/login_chave/edita.php" method="post" id="atualizaPerfil" name="atualizaPerfil">
  ...
  <tr>
    <td height="25" align="right" class="legendaLabel11"><strong>Chave de acesso</strong>:&nbsp;</td>
    <td height="25"><input name="bbp_adm_lock_log_chave" type="text" class="back_Campos" id="bbp_adm_lock_log_chave" value="<?php echo $login->bbp_adm_lock_log_chave; ?>" size="40"/></td>
    </tr>
  <tr>
  ...
  <tr>
    ...
    <input name="cadastrar" onclick="voltarURL('/e-solution/servicos/bbpass/modulo/config/login_chave/index.php?bbp_adm_loc_codigo=<?php echo $_GET['bbp_adm_loc_codigo']; ?>');" type="button" class="botaoVoltar back_input" id="cadastrar" value="&nbsp;&nbsp;&nbsp;Cancelar atualiza&ccedil;&atilde;o"/>
  <?php
  	$url 			= "/e-solution/servicos/bbpass/modulo/config/login_chave/edita.php?verificaRepetido=true&bbp_adm_lock_log_codigo=".$login->bbp_adm_lock_log_codigo."&bbp_adm_lock_log_chave=";
  	$tag 			= "resultado";
	$tagReferencia 	= "bbp_adm_lock_log_chave";
  ?>
...
/*===============================INICIO AUDITORIA POLICY=========================================*/
	...
	$Evento="Acessou a página de edição do usuário ".$login->bbp_adm_lock_log_chave." do módulo ".$modulo->nomeAplicacao($database_bbpass, $bbpass, $_GET['bbp_adm_loc_codigo']).".";
	EnviaPolicy($Evento);
/*===============================FIM AUDITORIA POLICY============================================*/
?>