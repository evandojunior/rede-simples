...
//select dos dados
	...
	$Sql = "SELECT date_format(pol_aud_momento,'%d/%m/%Y') AS pol_aud_momento, pol_aud_usuario, pol_aud_acao, pol_aud_ip, pol_aud_nivel, pol_aud_relevancia, pol_aud_codigo, pol_apl_nome, count(".agrupar($row_dadosGrafico['pol_graf_grupo']).") as Total FROM pol_auditoria RIGHT JOIN pol_aplicacao ON pol_auditoria.pol_apl_codigo = pol_aplicacao.pol_apl_codigo WHERE 1=1 $Condicoes $agrupar Order by Total DESC";
