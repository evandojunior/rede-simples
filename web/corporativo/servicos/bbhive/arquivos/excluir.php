...
//exit;
 ...
 require_once("../includes/autentica.php");
	...
	$_SESSION['nivel']="1";
	$Evento="Acessou a página de exclusão do arquivo cód. (".$_GET['bbh_arq_codigo'].") - (".$row_arquivo['bbh_arq_titulo'].") do ".$_SESSION['arqNome']." - BBHive corporativo.";
	EnviaPolicy($Evento);
...
<table width="98%" align="center" border="0" cellspacing="0" cellpadding="0" class="verdana_11">
  <tr>
    <td height="26" background="/corporativo/servicos/bbhive/images/barra_horizontal.jpg"><img src="/corporativo/servicos/bbhive/images/anexos-pequeno.gif" alt="" width="23" height="23" align="absmiddle" /><strong>&nbsp;<?php echo $_SESSION['arqNome']; ?> - EXCLUS&Atilde;O</strong>
...
<table width="98%" align="center" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td align="left" valign="middle" bgcolor="#FFFFFF" style="border-right:#CCCCCC solid 1px; border-bottom:#CCCCCC solid 1px">      &nbsp;<textarea title="Escreva uma breve descri&ccedil;&atilde;o do arquivo" class="formulario2" name="bbh_arq_descricao" id="bbh_arq_descricao" cols="70" rows="5" disabled="disabled"><?php echo $row_arquivo['bbh_arq_descricao']; ?></textarea></td>
  </tr>
  ...
  <tr>
    ...
    <td align="left" valign="middle" bgcolor="#FFFFFF" style="border-right:#CCCCCC solid 1px; border-bottom:#CCCCCC solid 1px">      &nbsp;<textarea title="Escreva uma breve observação do arquivo" class="formulario2" name="bbh_arq_obs_publico" id="bbh_arq_obs_publico" cols="70" rows="5" disabled="disabled"><?php echo $row_arquivo['bbh_arq_obs_publico']; ?></textarea></td>
  </tr>
  ...
  <tr>
    ...
    <td align="left" valign="middle" bgcolor="#F7F7F7" style="border-right:#CCCCCC solid 1px; border-bottom:#CCCCCC solid 1px"><span class="verdana_11 color">
      <input type="checkbox" name="bbh_arq_compartilhado" id="bbh_arq_compartilhado" <?php if($row_arquivo['bbh_arq_compartilhado']==1){ echo "checked=checked"; } ?> disabled="disabled"/>
  ...
  <tr>
    ...
    <td align="right" valign="middle" bgcolor="#F7F7F7"class="verdana_11" style="border-right:#CCCCCC solid 1px; border-bottom:#CCCCCC solid 1px;color:#393">&nbsp;</td>
    <td align="left" valign="middle" bgcolor="#F7F7F7" style="border-right:#CCCCCC solid 1px; border-bottom:#CCCCCC solid 1px"><span class="verdana_11 color">
      <input type="checkbox" name="bbh_arq_publico" id="bbh_arq_publico" <?php if($row_arquivo['bbh_arq_publico']==1){ echo "checked=checked"; } ?> disabled="disabled"/>
  ...
  <tr>
    <td height="30" colspan="3" align="right" valign="middle" bgcolor="#F7F7F7" style="border-left:#CCCCCC solid 1px; border-right:#CCCCCC solid 1px; border-bottom:#CCCCCC solid 1px">
      ...
      <input name="MM_delete" type="hidden" id="MM_delete" value="1">
      </span>
  ...
  <input type="button" name="button" id="button" value="Excluir" class="back_input" onclick="if(confirm('Tem certeza que deseja excluir este arquivo.\nClique em OK para confirmar este procedimento!')){document.getElementById('barra_progresso').style.display='block'; document.formUpload.submit();}" style="cursor:pointer;" />
      </td>
  </tr>
</table>
