...
//	include_once("classes/GeraGraficoBarra.php");
	require_once("../../includes/grafico/classes/GeraGraficoBarra.php");
	...
	$nomeTituloEixoY	= "Nmero de acesso";
	$nmTituloGrafico	= "Equipe Backsite";
	$exibir_legenda		= "sim";//s - Sim // n - No
...
<hr>
<i>Visualiza&ccedil;&atilde;o por gr&aacute;fico de barras e estat&iacute;stas</i>
<p>&nbsp;</p>
