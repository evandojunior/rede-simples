...
WHERE pol_aud_codigo = " . $pol_aud_codigo ;
	$infoEvento = mysqli_query($policy, $query_infoEvento) or die(mysql_error());
	$row_infoEvento = mysqli_fetch_assoc($infoEvento);
	$totalRows_infoEvento = mysqli_num_rows($infoEvento);
